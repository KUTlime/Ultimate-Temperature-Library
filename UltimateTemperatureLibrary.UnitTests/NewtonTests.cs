...
namespace UltimateTemperatureLibrary.UnitTests
{
	public class NewtonTests
	{
		...
		public class ToKelvinTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInKelvin, Newton.ToKelvin(Constants.AbsoluteZeroInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInKelvin, Newton.ToKelvin(Constants.MeltingPointH2OInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInKelvin, Newton.ToKelvin(Constants.BoilingPointH2OInNewton).Value);
		}
		...
		public class ToCelsiusTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToCelsiusAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInCelsius, Newton.ToCelsius(Constants.AbsoluteZeroInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToCelsiusMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInCelsius, Newton.ToCelsius(Constants.MeltingPointH2OInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToCelsiusBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInCelsius, Newton.ToCelsius(Constants.BoilingPointH2OInNewton).Value);
		}
		...
		public class ToFahrenheitTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToFahrenheitAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInFahrenheit, Newton.ToFahrenheit(Constants.AbsoluteZeroInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToFahrenheitMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInFahrenheit, Newton.ToFahrenheit(Constants.MeltingPointH2OInNewton).Value, 1e-13);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToFahrenheitBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInFahrenheit, Newton.ToFahrenheit(Constants.BoilingPointH2OInNewton).Value, 1e-13);
		}
		...
		public class ToRankineTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRankineAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInRankine, Newton.ToRankine(Constants.AbsoluteZeroInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRankineMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRankine, Newton.ToRankine(Constants.MeltingPointH2OInNewton).Value, 1e-13);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRankineBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRankine, Newton.ToRankine(Constants.BoilingPointH2OInNewton).Value);
		}
		...
		public class ToDelisleTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInDelisle, Newton.ToDelisle(Constants.AbsoluteZeroInNewton).Value, 1e-12);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInDelisle, Newton.ToDelisle(Constants.MeltingPointH2OInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInDelisle, Newton.ToDelisle(Constants.BoilingPointH2OInNewton).Value);
		}
		...
		public class ToRéaumurTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInRéaumur, Newton.ToRéaumur(Constants.AbsoluteZeroInNewton).Value, 1e-13);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRéaumur, Newton.ToRéaumur(Constants.MeltingPointH2OInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRéaumur, Newton.ToRéaumur(Constants.BoilingPointH2OInNewton).Value);
		}
		...
		public class ToRømerTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInRømer, Newton.ToRømer(Constants.AbsoluteZeroInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRømer, Newton.ToRømer(Constants.MeltingPointH2OInNewton).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRømer, Newton.ToRømer(Constants.BoilingPointH2OInNewton).Value);
		}
