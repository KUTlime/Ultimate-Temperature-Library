...
namespace UltimateTemperatureLibrary.UnitTests
{
	public class RéaumurTests
	{
		...
		public class ToKelvinTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInKelvin, Réaumur.ToKelvin(Constants.MeltingPointH2OInRéaumur).Value);
		...
		public class ToCelsiusTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToCelsiusMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInCelsius, Réaumur.ToCelsius(Constants.MeltingPointH2OInRéaumur).Value);
		...
		public class ToFahrenheitTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToFahrenheitMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInFahrenheit, Réaumur.ToFahrenheit(Constants.MeltingPointH2OInRéaumur).Value, 1e-13);
		...
		public class ToRankineTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRankineAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInRankine, Réaumur.ToRankine(Constants.AbsoluteZeroInRéaumur).Value);
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRankineBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRankine, Réaumur.ToRankine(Constants.BoilingPointH2OInRéaumur).Value);
		}
		...
		public class ToDelisleTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInDelisle, Réaumur.ToDelisle(Constants.MeltingPointH2OInRéaumur).Value);
		...
		public class ToNewtonTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToNewtonBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInNewton, Réaumur.ToNewton(Constants.BoilingPointH2OInRéaumur).Value);
		}
		...
		public class ToRømerTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRømer, Réaumur.ToRømer(Constants.MeltingPointH2OInRéaumur).Value);
