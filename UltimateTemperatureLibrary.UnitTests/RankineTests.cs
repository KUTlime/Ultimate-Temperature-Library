...
namespace UltimateTemperatureLibrary.UnitTests
{
	public class RankineTests
	{
		...
		public class ToKelvinTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInKelvin, Rankine.ToKelvin(Constants.MeltingPointH2OInRankine).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInKelvin, Rankine.ToKelvin(Constants.BoilingPointH2OInRankine).Value);
		}
		...
		public class ToCelsiusTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToCelsiusMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInCelsius, Rankine.ToCelsius(Constants.MeltingPointH2OInRankine).Value);
		...
		public class ToFahrenheitTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToFahrenheitMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInFahrenheit, Rankine.ToFahrenheit(Constants.MeltingPointH2OInRankine).Value, OperationOverDoublePrecision.HighPrecision);
		...
		public class ToDelisleTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInDelisle, Rankine.ToDelisle(Constants.MeltingPointH2OInRankine).Value);
		...
		public class ToRéaumurTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRéaumur, Rankine.ToRéaumur(Constants.BoilingPointH2OInRankine).Value);
		}
		...
		public class ToRømerTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRømer, Rankine.ToRømer(Constants.MeltingPointH2OInRankine).Value);
