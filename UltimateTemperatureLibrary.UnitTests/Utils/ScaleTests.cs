...
namespace UltimateTemperatureLibrary.UnitTests.Utils
{
	...
	public class ScaleTests
	{
		...
		public class IdentifyMethodTests
		{
			...
			public void CelsiusIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Celsius, Scale.Identify(testDescription));
			...
			public void KelvinIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Kelvin, Scale.Identify(testDescription));
			...
			public void FahrenheitIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Fahrenheit, Scale.Identify(testDescription));
			...
			public void RankineIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Rankine, Scale.Identify(testDescription));
			...
			public void DelisleIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Delisle, Scale.Identify(testDescription));
			...
			public void NewtonIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Newton, Scale.Identify(testDescription));
			...
			public void RéaumurIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Réaumur, Scale.Identify(testDescription));
			...
			public void RømerIdentificationTest(UInt32 testNumber, string testDescription) => Assert.AreEqual(TemperatureScale.Rømer, Scale.Identify(testDescription));

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			[ExpectedException(typeof(ArgumentException))]
			public void InvalidScaleStringTest() => Scale.Identify((string) null);
		}
	}
}
