...
namespace UltimateTemperatureLibrary.UnitTests
{
    public class KelvinTests
    {
        ...
        public class ToCelsiusTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInCelsius, Kelvin.ToCelsius(Constants.AbsoluteZeroInKelvin).Value, 1e-12);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInCelsius, Kelvin.ToCelsius(Constants.MeltingPointH2OInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInCelsius, Kelvin.ToCelsius(Constants.BoilingPointH2OInKelvin).Value);
            }
        }
        ...
        public class ToFahrenheitTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInFahrenheit, Kelvin.ToFahrenheit(Constants.AbsoluteZeroInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInFahrenheit, Kelvin.ToFahrenheit(Constants.MeltingPointH2OInKelvin).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInFahrenheit, Kelvin.ToFahrenheit(Constants.BoilingPointH2OInKelvin).Value, 1e-13);
            }
        }
        ...
        public class ToRankineTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRankine, Kelvin.ToRankine(Constants.AbsoluteZeroInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRankine, Kelvin.ToRankine(Constants.MeltingPointH2OInKelvin).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRankine, Kelvin.ToRankine(Constants.BoilingPointH2OInKelvin).Value);
            }
        }
        ...
        public class ToDelisleTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInDelisle, Kelvin.ToDelisle(Constants.AbsoluteZeroInKelvin).Value, 1e-12);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInDelisle, Kelvin.ToDelisle(Constants.MeltingPointH2OInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInDelisle, Kelvin.ToDelisle(Constants.BoilingPointH2OInKelvin).Value);
            }
        }
        ...
        public class ToNewtonTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInNewton, Kelvin.ToNewton(Constants.AbsoluteZeroInKelvin).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInNewton, Kelvin.ToNewton(Constants.MeltingPointH2OInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInNewton, Kelvin.ToNewton(Constants.BoilingPointH2OInKelvin).Value);
            }
        }
        ...
        public class ToRéaumurTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRéaumur, Kelvin.ToRéaumur(Constants.AbsoluteZeroInKelvin).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRéaumur, Kelvin.ToRéaumur(Constants.MeltingPointH2OInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRéaumur, Kelvin.ToRéaumur(Constants.BoilingPointH2OInKelvin).Value);
            }
        }
        ...
        public class ToRømerTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRømer, Kelvin.ToRømer(Constants.AbsoluteZeroInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRømer, Kelvin.ToRømer(Constants.MeltingPointH2OInKelvin).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRømer, Kelvin.ToRømer(Constants.BoilingPointH2OInKelvin).Value);
            }
        }
    }
