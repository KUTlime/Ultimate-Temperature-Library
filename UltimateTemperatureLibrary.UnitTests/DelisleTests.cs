...
namespace UltimateTemperatureLibrary.UnitTests
{
    public class DelisleTests
    {
        ...
        public class ToKelvinTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInKelvin, Delisle.ToKelvin(Constants.AbsoluteZeroInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInKelvin, Delisle.ToKelvin(Constants.MeltingPointH2OInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInKelvin, Delisle.ToKelvin(Constants.BoilingPointH2OInDelisle).Value);
            }
        }
        ...
        public class ToCelsiusTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInCelsius, Delisle.ToCelsius(Constants.AbsoluteZeroInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInCelsius, Delisle.ToCelsius(Constants.MeltingPointH2OInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInCelsius, Delisle.ToCelsius(Constants.BoilingPointH2OInDelisle).Value);
            }
        }
        ...
        public class ToFahrenheitTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInFahrenheit, Delisle.ToFahrenheit(Constants.AbsoluteZeroInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInFahrenheit, Delisle.ToFahrenheit(Constants.MeltingPointH2OInDelisle).Value, OperationOverDoublePrecision.HighPrecision);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInFahrenheit, Delisle.ToFahrenheit(Constants.BoilingPointH2OInDelisle).Value, OperationOverDoublePrecision.HighPrecision);
            }
        }
        ...
        public class ToRankineTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRankine, Delisle.ToRankine(Constants.AbsoluteZeroInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRankine, Delisle.ToRankine(Constants.MeltingPointH2OInDelisle).Value, OperationOverDoublePrecision.HighPrecision);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRankine, Delisle.ToRankine(Constants.BoilingPointH2OInDelisle).Value);
            }
        }
        ...
        public class ToNewtonTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInNewton, Delisle.ToNewton(Constants.AbsoluteZeroInDelisle).Value, OperationOverDoublePrecision.HighPrecision);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInNewton, Delisle.ToNewton(Constants.MeltingPointH2OInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInNewton, Delisle.ToNewton(Constants.BoilingPointH2OInDelisle).Value);
            }
        }
        ...
        public class ToRéaumurTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRéaumur, Delisle.ToRéaumur(Constants.AbsoluteZeroInDelisle).Value, OperationOverDoublePrecision.HighPrecision);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRéaumur, Delisle.ToRéaumur(Constants.MeltingPointH2OInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRéaumur, Delisle.ToRéaumur(Constants.BoilingPointH2OInDelisle).Value);
            }
        }
        ...
        public class ToRømerTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRømer, Delisle.ToRømer(Constants.AbsoluteZeroInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRømer, Delisle.ToRømer(Constants.MeltingPointH2OInDelisle).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRømer, Delisle.ToRømer(Constants.BoilingPointH2OInDelisle).Value);
            }
        }
