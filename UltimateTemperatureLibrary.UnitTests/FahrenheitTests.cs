...
namespace UltimateTemperatureLibrary.UnitTests
{
	public class FahrenheitTests
	{
		...
		public class ToKelvinTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToKelvinBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInKelvin, Fahrenheit.ToKelvin(Constants.BoilingPointH2OInFahrenheit).Value, OperationOverDoublePrecision.HighPrecision);
		}
		...
		public class ToDelisleTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInDelisle, Fahrenheit.ToDelisle(Constants.AbsoluteZeroInFahrenheit).Value, 1e-12);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInDelisle, Fahrenheit.ToDelisle(Constants.MeltingPointH2OInFahrenheit).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToDelisleBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInDelisle, Fahrenheit.ToDelisle(Constants.BoilingPointH2OInFahrenheit).Value, OperationOverDoublePrecision.HighPrecision);
		}
		...
		public class ToNewtonTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToNewtonAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInNewton, Fahrenheit.ToNewton(Constants.AbsoluteZeroInFahrenheit).Value, 1e-13);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToNewtonMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInNewton, Fahrenheit.ToNewton(Constants.MeltingPointH2OInFahrenheit).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToNewtonBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInNewton, Fahrenheit.ToNewton(Constants.BoilingPointH2OInFahrenheit).Value, OperationOverDoublePrecision.HighPrecision);
		}
		...
		public class ToRéaumurTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInRéaumur, Fahrenheit.ToRéaumur(Constants.AbsoluteZeroInFahrenheit).Value, 1e-13);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRéaumur, Fahrenheit.ToRéaumur(Constants.MeltingPointH2OInFahrenheit).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRéaumurBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRéaumur, Fahrenheit.ToRéaumur(Constants.BoilingPointH2OInFahrenheit).Value, OperationOverDoublePrecision.HighPrecision);
		}
		...
		public class ToRømerTests
		{
			...
			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerAbsoluteZeroTest() => Assert.AreEqual(expected: Constants.AbsoluteZeroInRømer, Fahrenheit.ToRømer(Constants.AbsoluteZeroInFahrenheit).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerMeltingPointTest() => Assert.AreEqual(expected: Constants.MeltingPointH2OInRømer, Fahrenheit.ToRømer(Constants.MeltingPointH2OInFahrenheit).Value);

			[TestCategory(TestCategory.BasicTests)]
			[TestMethod]
			public void StaticFromDoubleToRømerBoilingPointTest() => Assert.AreEqual(expected: Constants.BoilingPointH2OInRømer, Fahrenheit.ToRømer(Constants.BoilingPointH2OInFahrenheit).Value, OperationOverDoublePrecision.HighPrecision);
		}
