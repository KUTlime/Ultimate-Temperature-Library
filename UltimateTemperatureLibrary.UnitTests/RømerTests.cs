...
namespace UltimateTemperatureLibrary.UnitTests
{
    public class RømerTests
    {
        ...
        public class ToKelvinTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInKelvin, Rømer.ToKelvin(Constants.AbsoluteZeroInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInKelvin, Rømer.ToKelvin(Constants.MeltingPointH2OInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInKelvin, Rømer.ToKelvin(Constants.BoilingPointH2OInRømer).Value);
            }
        }
        ...
        public class ToCelsiusTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInCelsius, Rømer.ToCelsius(Constants.AbsoluteZeroInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInCelsius, Rømer.ToCelsius(Constants.MeltingPointH2OInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInCelsius, Rømer.ToCelsius(Constants.BoilingPointH2OInRømer).Value);
            }
        }
        ...
        public class ToFahrenheitTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInFahrenheit, Rømer.ToFahrenheit(Constants.AbsoluteZeroInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInFahrenheit, Rømer.ToFahrenheit(Constants.MeltingPointH2OInRømer).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInFahrenheit, Rømer.ToFahrenheit(Constants.BoilingPointH2OInRømer).Value, 1e-13);
            }
        }
        ...
        public class ToRankineTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRankine, Rømer.ToRankine(Constants.AbsoluteZeroInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRankine, Rømer.ToRankine(Constants.MeltingPointH2OInRømer).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRankine, Rømer.ToRankine(Constants.BoilingPointH2OInRømer).Value);
            }
        }
        ...
        public class ToDelisleTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInDelisle, Rømer.ToDelisle(Constants.AbsoluteZeroInRømer).Value, 1e-12);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInDelisle, Rømer.ToDelisle(Constants.MeltingPointH2OInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInDelisle, Rømer.ToDelisle(Constants.BoilingPointH2OInRømer).Value);
            }
        }
        ...
        public class ToNewtonTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInNewton, Rømer.ToNewton(Constants.AbsoluteZeroInRømer).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInNewton, Rømer.ToNewton(Constants.MeltingPointH2OInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInNewton, Rømer.ToNewton(Constants.BoilingPointH2OInRømer).Value);
            }
        }
        ...
        public class ToRéaumurTests
        {
            ...
            {
                Assert.AreEqual(expected: Constants.AbsoluteZeroInRéaumur, Rømer.ToRéaumur(Constants.AbsoluteZeroInRømer).Value, 1e-13);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.MeltingPointH2OInRéaumur, Rømer.ToRéaumur(Constants.MeltingPointH2OInRømer).Value);
            }
            ...
            {
                Assert.AreEqual(expected: Constants.BoilingPointH2OInRéaumur, Rømer.ToRéaumur(Constants.BoilingPointH2OInRømer).Value);
            }
        }
