...
namespace UltimateTemperatureLibrary
{
    ...
    public class Fahrenheit : TemperatureUnit, IConversionToKelvin, IConversionToCelsius, IConversionToFahrenheit, IConversionToNewton, IConversionToDelisle, IConversionToRankine, IConversionToRéaumur, IConversionToRømer
    {
        ...
        public Fahrenheit(IConversionToFahrenheit fahrenheit)
        {
            Value = fahrenheit?.ToFahrenheit()?.Value ?? Constants.AbsoluteZeroInFahrenheit;
        }
        ...
        /// </summary>
        public override string[] RegexPatterns { get; protected set; } = { "F", "Fahrenheit", "Fah", "f", "fahrenheit", "fah" };
        ...
        {
            return new Kelvin(Converter.Fah2Kel(Value));
        }
        ...
        {
            return new Celsius(Converter.Fah2Cel(Value));
        }
        ...
        {
            return new Rankine(Converter.Fah2Ran(Value));
        }
        ...
        {
            return new Delisle(Converter.Fah2Del(Value));
        }
        ...
        {
            return new Newton(Converter.Fah2New(Value));
        }
        ...
        {
            return new Réaumur(Converter.Fah2Réau(Value));
        }
        ...
        {
            return new Rømer(Converter.Fah2Røm(Value));
        }
        #endregion
        ...
        public static new Fahrenheit ToFahrenheit(IConversionToFahrenheit fahrenheit)
        {
            if (fahrenheit is Fahrenheit validFahrenheit)
            {
                return validFahrenheit;
            }
