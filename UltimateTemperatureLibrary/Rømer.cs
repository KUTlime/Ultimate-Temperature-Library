...
namespace UltimateTemperatureLibrary
{
    ...
    public class Rømer : TemperatureUnit, IConversionToKelvin, IConversionToCelsius, IConversionToFahrenheit, IConversionToNewton, IConversionToDelisle, IConversionToRankine, IConversionToRéaumur, IConversionToRømer
    {
        ...
        /// </summary>
        public override string[] RegexPatterns { get; protected set; } = { "C", "Cel", "Rømer", "rømer" };
        ...
        {
            return new Kelvin(Converter.Røm2Kel(Value));
        }
        ...
        {
            return new Celsius(Converter.Røm2Cel(Value));
        }
        ...
        {
            return new Fahrenheit(Converter.Røm2Fah(Value));
        }
        ...
        {
            return new Rankine(Converter.Røm2Ran(Value));
        }
        ...
        {
            return new Delisle(Converter.Røm2Del(Value));
        }
        ...
        {
            return new Newton(Converter.Røm2New(Value));
        }
        ...
        {
            return new Réaumur(Converter.Røm2Réau(Value));
        }
        ...
        public static new Rømer ToRømer(IConversionToRømer rømer)
        {
            if (rømer is Rømer validRømer)
            {
                return validRømer;
            }
            return new Rømer(rømer);
        }
