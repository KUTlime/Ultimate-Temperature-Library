...
namespace UltimateTemperatureLibrary
{
    ...
    public class Réaumur : TemperatureUnit, IConversionToKelvin, IConversionToCelsius, IConversionToFahrenheit, IConversionToNewton, IConversionToDelisle, IConversionToRankine, IConversionToRéaumur, IConversionToRømer
    {
        ...
        public Réaumur(IConversionToRéaumur réaumur)
        {
            Value = réaumur?.ToRéaumur()?.Value ?? Constants.AbsoluteZeroInRéaumur;
        }
        ...
        {
            return new Kelvin(Converter.Réau2Kel(Value));
        }
        ...
        {
            return new Celsius(Converter.Réau2Cel(Value));
        }
        ...
        {
            return new Fahrenheit(Converter.Réau2Fah(Value));
        }
        ...
        {
            return new Rankine(Converter.Réau2Ran(Value));
        }
        ...
        {
            return new Delisle(Converter.Réau2Del(Value));
        }
        ...
        {
            return new Newton(Converter.Réau2New(Value));
        }
        ...
        {
            return new Rømer(Converter.Réau2Røm(Value));
        }
        #endregion
        ...
        public static new Réaumur ToRéaumur(IConversionToRéaumur réaumur)
        {
            if (réaumur is Réaumur validRéaumur)
            {
                return validRéaumur;
            }
            return new Réaumur(réaumur);
        }
