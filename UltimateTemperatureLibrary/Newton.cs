...
namespace UltimateTemperatureLibrary
{
	...
	public class Newton : TemperatureUnit, IConversionToKelvin, IConversionToCelsius, IConversionToFahrenheit, IConversionToNewton, IConversionToDelisle, IConversionToRankine, IConversionToRéaumur, IConversionToRømer
	{
		...
		/// </summary>
		public Newton() => Value = Constants.AbsoluteZeroInNewton;
		...
		public Newton(IConversionToNewton newton) => Value = newton?.ToNewton()?.Value ?? Constants.AbsoluteZeroInNewton;
		...
		public Newton(string value)
		{
			...
			Value = Converter.Kel2New(TemperatureUnitParser.Parse(value)?.ToKelvin()?.Value ?? Constants.AbsoluteZeroInKelvin);
		}
		...
		public Newton(double value) => Value = value;
		...
		public Kelvin ToKelvin() => new Kelvin(Converter.New2Kel(Value));
		...
		/// <remarks>Use .Value property to get double value.</remarks>
		public Celsius ToCelsius() => new Celsius(Converter.New2Cel(Value));
		...
		/// <remarks>Use .Value property to get double value.</remarks>
		public Fahrenheit ToFahrenheit() => new Fahrenheit(Converter.New2Fah(Value));
		...
		/// <remarks>Use .Value property to get double value.</remarks>
		public Rankine ToRankine() => new Rankine(Converter.New2Ran(Value));
		...
		/// <remarks>Use .Value property to get double value.</remarks>
		public Delisle ToDelisle() => new Delisle(Converter.New2Del(Value));
		...
		/// <remarks>Use .Value property to get double value.</remarks>
		public Réaumur ToRéaumur() => new Réaumur(Converter.New2Réau(Value));
		...
		/// <remarks>Use .Value property to get double value.</remarks>
		public Rømer ToRømer() => new Rømer(Converter.New2Røm(Value));
		...
		/// <returns>A value in Kelvin.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Kelvin ToKelvin(double value) => new Kelvin(Converter.New2Kel(value));
		...
		/// <returns>A value in [°] Celsius.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Celsius ToCelsius(double value) => new Celsius(Converter.New2Cel(value));
		...
		/// <returns>A value in [°] Fahrenheit.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Fahrenheit ToFahrenheit(double value) => new Fahrenheit(Converter.New2Fah(value));
		...
		/// <returns>A value in [°] Rankine.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Rankine ToRankine(double value) => new Rankine(Converter.New2Ran(value));
		...
		/// <returns>A value in [°] Delisle.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Delisle ToDelisle(double value) => new Delisle(Converter.New2Del(value));
		...
		public static new Newton ToNewton(IConversionToNewton newton) => newton is Newton validNewton ? validNewton : new Newton(newton);
		...
		/// <returns>A value in [°] Réaumur.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Réaumur ToRéaumur(double value) => new Réaumur(Converter.New2Réau(value));
		...
		/// <returns>A value in Rømer.</returns>
		/// <remarks>Use .Value property to get double value.</remarks>
		public static Rømer ToRømer(double value) => new Rømer(Converter.New2Røm(value));
		...
		public static Newton operator +(Newton newton, IConversionToNewton b) =>
			new Newton(
				(newton?.Value ?? Constants.AbsoluteZeroInNewton) +
				(b?.ToNewton()?.Value ?? 0.0)
			);
